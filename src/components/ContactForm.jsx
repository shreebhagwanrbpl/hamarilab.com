...
export default function ContactForm({
  ...
  return (
    <div className="rounded-3xl border border-slate-200/90 bg-white p-8 sm:p-10 shadow-xl shadow-teal-900/5">
      {title && (
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-2xl border border-slate-200 bg-[#f0fdf9]/40 px-4 py-3.5 pl-11 text-sm text-[#0f172a] transition-all focus:border-[#0d9488] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#0d9488]/20"
                required
              />
              <User
                size={18}
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full flex items-center justify-center gap-2 rounded-2xl bg-[#0d9488] py-4 text-base font-bold text-white shadow-lg shadow-[#0d9488]/20 transition-all hover:bg-[#0f766e] hover:shadow-xl hover:shadow-[#0d9488]/30 disabled:opacity-60"
        >
          {submitting ? (
