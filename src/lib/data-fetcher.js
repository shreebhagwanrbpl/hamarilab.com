...
export async function fetchHomeData() {
    return fetchDocCached("websites/hamarilabcom/pages/home");
}

export async function fetchContactData() {
    return fetchDocCached("websites/hamarilabcom/pages/contact");
}

export async function fetchServicesData() {
    return fetchDocCached("websites/hamarilabcom/pages/services");
}

export async function fetchDistrictData(district) {
    if (!district) return null;
    return fetchDocCached(`websites/hamarilabcom/districts/${district}`);
}
...
export function subscribeToCatalog(onUpdate) {
    ...
    try {
        const legacyUnsub = onSnapshot(
            doc(db, "websites", "hamarilabcom", "pages", "products"),
            (docSnap) => {
                if (docSnap.exists()) {
